    ...
    <div className='max-w-[1640px] mx-auto p-4'>
        <div className='max-h-[500px] relative'>
            <div className='absolute w-full h-full text-gray-200 max-h-[500px] bg-black/50 flex flex-col justify-center'>
                <h1 className='px-4 text-4xl sm:text-5xl md-6xl lg:7xl font-bold'>The <span className='text-orange-200'>Best</span></h1>
                <h1 className='px-4 text-4xl sm:text-5xl md-6xl lg:7xl font-bold'><span className='text-orange-200'>Foods </span>Delivered</h1>
            </div>
